...
class RestaurantServiceTest {
  ...
  //   assertEquals(getServingRadius(loadRestaurantsDuringPeakHours(), LocalTime.of(8, 0)),"5.0");
  // }
  // @Test
  // void peakHourServingRadiusOf3KmsAt9Am() throws IOException {
  //   assertEquals(getServingRadius(loadRestaurantsDuringPeakHours(), LocalTime.of(9, 0)),"5.0");
  // }

  // @Test
  // void peakHourServingRadiusOf3KmsAt10Am() throws IOException {
  //   assertEquals(getServingRadius(loadRestaurantsDuringPeakHours(), LocalTime.of(10, 0)),"5.0");
  // }

  // @Test
  // void peakHourServingRadiusOf3KmsAt9Pm() throws IOException {
  //   assertEquals(getServingRadius(loadRestaurantsDuringPeakHours(), LocalTime.of(21, 0)),"3.0");
  // }

  // @Test
  // void peakHourServingRadiusOf3KmsAt2Pm() throws IOException {
  //   assertEquals(getServingRadius(loadRestaurantsDuringPeakHours(), LocalTime.of(14, 0)),"5.0");
  // }

  // @Test
  // void peakHourServingRadiusOf3KmsAt1Pm() throws IOException {
  //   assertEquals(getServingRadius(loadRestaurantsDuringPeakHours(), LocalTime.of(13, 0)),"5.0");
  // }
  ...
  void normalHourServingRadiusIs5Kms() throws IOException {
    ...
    when(restaurantRepositoryServiceMock.findAllRestaurantsCloseBy(any(Double.class),any(Double.class) ,any(LocalTime.class), any(Double.class))).thenReturn(restaurants);
